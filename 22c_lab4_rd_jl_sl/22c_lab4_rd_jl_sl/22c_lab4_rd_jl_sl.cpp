...
template <typename Type>
void selectionSort(int, Array<Type>*, ofstream &, int index = 0);
...
template <typename Type>
void mergeSort(Array<Type>*, int, int, ofstream &);

template <typename Type>
void print(Array<Type>*, int, ofstream &);
...
int main()
{
	...
	myfile << "Stephen Lee, John Le, Robert Dyer:" << endl << endl;
	...
	else if (type == "string")
	{
		...
		print(selectCopy, dataitems, myfile);
		...
		selectionSort(dataitems, selectCopy, myfile);
		print(selectCopy, dataitems, myfile);
		cout << endl << endl;
		...
		print(insertCopy, dataitems, myfile);
		cout << endl << endl;

		//Quick Sort
		cout << "Quick Sort: " << endl;
		myfile << "Quick Sort: " << endl;
		quickSort(quickCopy, 0, dataitems - 1);
		print(quickCopy, dataitems, myfile);
		cout << endl << endl;

		//Merge Sort
		cout << "Merge Sort: " << endl << endl;
		myfile << "Merge Sort: " << endl << endl;
		mergeSort(mergeCopy, 0, dataitems - 1, myfile);
		print(mergeCopy, dataitems, myfile);
		cout << endl << endl;
	}
...
template <typename Type>
void selectionSort(int n, Array<Type>* a, ofstream &outfile, int index)
{
	...
	selectionSort(n, a, outfile, index + 1);
	return;
}
...
template <typename Type>
void mergeSort(Array<Type> *a, int start, int end, ofstream &outfile)
{
	if (start < end)
	{
		cout << "Sorting...";
		...
		mergeSort(a, start, middle, outfile);
		mergeSort(a, middle + 1, end, outfile);
		merge(a, start, middle, end);

		print(a, end - start + 1, outfile);
	}
...
template <typename Type>
void print(Array<Type> *a, int b, ofstream &outfile)
{
	cout << "Result: ";
